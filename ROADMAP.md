...
**Definición de Hecho (DoD):**
- [ ] Todas las vistas implementan rigurosamente la paleta y tipografía de `design-dark.md` (fondo `#1C1C1C`, cards `#2A2A2A`, acento `#17a163`, fuentes Inter y JetBrains Mono).
...
- [ ] Gráficas de postura y severidades renderizan correctamente mediante Apache ECharts.
- [ ] Cero literales de texto hardcodeados; auditoría de internacionalización i18n limpia en español e inglés.
